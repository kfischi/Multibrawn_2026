      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'מומחים במציאת צימרים, וילות יוקרה ומתחמי אירועים בישראל. שירות אישי ומקצועי מזה 9 שנים.',
            ...
            foundingDate: '2016',
            slogan: 'הלוקיישן המושלם מחכה לכם'
          })
        }}
      />
      ...
      <div className={styles.homePage}>
        ...
        <section className={styles.heroVideo}>
          <video 
            ...
            loop 
            playsInline
            aria-label="וידאו רקע של נכסים יוקרתיים"
          >
            <source 
        ...
        <section className={`${styles.whyUs} ${styles.revealOnScroll}`}>
          <div className={styles.container}>
            ...
            <p className={styles.sectionSubtitle}>המומחים שלכם למציאת הלוקיישן המושלם</p>
            ...
            <div className={styles.whyUsGrid}>
              <div className={styles.whyUsCard}>
                ...
                <h3>9+ שנות ניסיון</h3>
                <p>מומחים במציאת הלוקיישן המושלם עם ניסיון עשיר ומוכח</p>
              </div>
              ...
              <div className={styles.whyUsCard}>
                ...
                <p>עזרנו לאלפי משפחות למצוא את החלום שלהם במקום המושלם</p>
              </div>
              ...
              <div className={styles.whyUsCard}>
                ...
                <h3>רק נכסים מאומתים</h3>
                <p>כל נכס עובר בדיקה קפדנית כדי להבטיח את החוויה הטובה ביותר</p>
              </div>
              ...
              <div className={styles.whyUsCard}>
                ...
                <p>אנחנו כאן בשבילכם בכל שעה, עם ליווי צמוד לאורך כל הדרך</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* Location Cards Grid */}
        <section className={`${styles.locationsGrid} ${styles.revealOnScroll}`}>
          <Link href="/gallery?category=villa" className={styles.locationCard}>
            <Image
              ...
              alt="וילות מפוארות להשכרה בישראל - בריכות פרטיות וגינות מטופחות"
              fill
          ...
          <Link href="/gallery?category=zimmer" className={styles.locationCard}>
            <Image
              ...
              alt="צימרים רומנטיים עם ג'קוזי פרטי ונוף מרהיב"
              fill
              className={styles.locationImage}
              loading="lazy"
            />
          ...
          <Link href="/gallery?category=apartment" className={styles.locationCard}>
            <Image
              ...
              alt="דירות נופש מעוצבות במרכז תל אביב וירושלים"
              fill
              className={styles.locationImage}
              loading="lazy"
            />
          ...
          <Link href="/gallery?category=hotel" className={styles.locationCard}>
            <Image
              ...
              alt="מלונות בוטיק יוקרתיים בישראל - חוויית אירוח ייחודית"
              fill
              className={styles.locationImage}
              loading="lazy"
            />
          ...
          <Link href="/gallery?category=event" className={styles.locationCard}>
            <Image
              ...
              alt="מתחמי אירועים מרהיבים לחתונות ואירועים עסקיים"
              fill
              className={styles.locationImage}
              loading="lazy"
            />
        ...
        <section className={`${styles.testimonials} ${styles.revealOnScroll}`}>
          <div className={styles.container}>
            ...
            <p className={styles.sectionSubtitle}>אלפי לקוחות מרוצים בחרו בנו - הנה מה שהם חושבים</p>
            ...
            <div className={styles.testimonialsGrid}>
              <div className={styles.testimonialCard}>
                ...
                <p className={styles.testimonialText}>
                  "מצאו לנו וילה מדהימה בצפון! השירות היה מעולה והמקום עלה על כל הציפיות. תודה רבה על המקצועיות והליווי הצמוד!"
                </p>
                <div className={styles.testimonialAuthor}>
                  <div className={styles.testimonialAvatar}>ש</div>
                  <div>
                    <div className={styles.testimonialName}>שרה כהן</div>
                    <div className={styles.testimonialLocation}>תל אביב</div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.testimonialCard}>
                ...
                <p className={styles.testimonialText}>
                  "אחרי שנים של חיפושים, סוף סוף מצאנו את הצימר המושלם לחופשה המשפחתית שלנו. ליווי צמוד לאורך כל הדרך!"
                </p>
                <div className={styles.testimonialAuthor}>
                  <div className={styles.testimonialAvatar}>ד</div>
                  <div>
                    <div className={styles.testimonialName}>דני לוי</div>
                    <div className={styles.testimonialLocation}>ירושלים</div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.testimonialCard}>
                ...
                <p className={styles.testimonialText}>
                  "מקצועיות ללא פשרות. ליוו אותנו בכל שלב מרגע ההזמנה ועד שנכנסנו למתחם. חוויה מושלמת לאירוע שלנו!"
                </p>
                <div className={styles.testimonialAuthor}>
                  <div className={styles.testimonialAvatar}>מ</div>
                  <div>
                    <div className={styles.testimonialName}>מיכל רוזן</div>
                    <div className={styles.testimonialLocation}>חיפה</div>
                  </div>
                </div>
              </div>
            </div>
